...
Наиболее редкими оказались иностранные слова и заимствования (в обоих текстах). Это объясняется тем, что в русскоязычных текстах редко можно встретить иностранную лексику. Чтобы быстро получить этот результат, необходимо проделать те же действия, что и при поиске наиболее частотных слов (Sort by Freq), но поставить галочку у "Invert Order", что инвертирует поиск и быстро выдаст необходимый результат. 
...
Как можно видеть из представленных выше скриншотов, 
